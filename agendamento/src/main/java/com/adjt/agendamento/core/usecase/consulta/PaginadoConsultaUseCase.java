...
public class PaginadoConsultaUseCase<T> {
    ...
    private PaginadoConsultaUseCase(UsuarioPort<Usuario> usuarioPort) {
        this.usuarioPort = usuarioPort;
    }

    public static <T> PaginadoConsultaUseCase<T> create(UsuarioPort<Usuario> usuarioPort) {
        return new PaginadoConsultaUseCase<>(usuarioPort);
    }
